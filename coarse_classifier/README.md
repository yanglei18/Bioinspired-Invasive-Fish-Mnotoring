...
This directory contains the coarse-grained fish classification training, multi-GPU inference, dataset-building, and threshold-optimization workflow.
...
```text
coarse_classifier/configs/default.yaml
```

Main launcher:

```bash
bash coarse_classifier/scripts/train_script.sh coarse_classifier/configs/default.yaml 1
```
...
```text
data/coarse-classifier-dataset/SuppExps/Invasive-S4-A/train
data/coarse-classifier-dataset/SuppExps/Invasive-S4-A/val
```
...
```bash
bash coarse_classifier/scripts/train_script.sh \
  coarse_classifier/configs/invasive-s4-b.yaml \
  1

python3 coarse_classifier/train.py \
  --config coarse_classifier/configs/invasive-s4-b.yaml
```
...
```bash
bash coarse_classifier/scripts/inference_script.sh coarse_classifier/configs/default.yaml 1
```
