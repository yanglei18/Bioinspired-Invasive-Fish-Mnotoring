...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            ...
            "soft links under data/coarse-classifier-dataset/SuppExps."
        ),
    ...
    parser.add_argument(
        "--source_root",
        type=Path,
        default=PROJECT_ROOT / "data/coarse-classifier-dataset/invasive-dataset",
        help="Source dataset root that directly contains class subdirectories.",
    )
    parser.add_argument(
        "--target_root",
        type=Path,
        default=PROJECT_ROOT / "data/coarse-classifier-dataset/SuppExps",
