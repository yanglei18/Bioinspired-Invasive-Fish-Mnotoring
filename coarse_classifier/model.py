...
class FishClassifier(nn.Module):
    ...
    def forward(self, x1, x2=None, labels=None):
        ...
        radius regularization (KL and L2), and center distance regularization (KL and L2)
        ...
        Returns:
            tuple: (total_loss, byol_loss, radius_loss_kl, center_distance_loss_kl, radius_loss_l2, center_distance_loss_l2)
        """
