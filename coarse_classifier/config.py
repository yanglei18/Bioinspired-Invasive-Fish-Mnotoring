...
@dataclass(frozen=True)
class DataConfig:
    train_dir: str = "data/coarse-classifier-dataset/SuppExps/Invasive-S4-A/train"
    val_dir: str = "data/coarse-classifier-dataset/SuppExps/Invasive-S4-A/val"
    reference_dir: str = "data/coarse-classifier-dataset/SuppExps/Invasive-S4-A/train"


@dataclass(frozen=True)
class OutputConfig:
    save_path: str = "work_dirs/coaser-classifier-ouputs/Invasive-S4-A"
    evaluation_dir: str = "work_dirs/coaser-classifier-ouputs/Invasive-S4-A/evaluation"
    model_path: str = "work_dirs/coaser-classifier-ouputs/Invasive-S4-A/fish_classifier_epoch_80.pth"
...
def load_classifier_config(config_path: str | Path | None = None) -> CoarseClassifierConfig:
    ...
    try:
        ...
        raise ModuleNotFoundError(
            "PyYAML is required to load coarse_classifier YAML configs. "
