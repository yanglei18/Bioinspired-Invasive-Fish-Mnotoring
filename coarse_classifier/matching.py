...
from dataset import inference_transform as transform
...
class BatchInferenceModel:
    ...
    def process_batch(self, batch):
        ...
        for i in range(len(images)):
            ...
            best_l2_min = class_stats[best_class]['l2_min']  # 最佳类别的L2距离最小值
