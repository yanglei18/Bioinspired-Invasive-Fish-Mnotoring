...
AGGREGATED_ANNOTATION_FILENAME = "perdiction.json"
LEGACY_AGGREGATED_ANNOTATION_FILENAMES = ("annotations.json",)
...
def has_aggregated_annotations(annotation_path: str | os.PathLike[str]) -> bool:
    return get_existing_aggregated_annotation_path(annotation_path) is not None
