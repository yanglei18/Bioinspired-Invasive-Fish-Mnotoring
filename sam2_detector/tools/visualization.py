...
SAM2_ROOT = Path(__file__).resolve().parents[1]
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--annotation_det_dir",
        type=Path,
        default=Path("work_dirs/sam2_prediction/annotation_det"),
        help="Prediction annotation directory. Supports perdiction.json and legacy per-frame JSON folders.",
    )
    parser.add_argument(
        "--annotation_mask_dir",
        type=Path,
        default=Path("work_dirs/sam2_prediction/annotation_mask"),
        help="Mask directory containing per-frame .npy instance masks.",
    )
    parser.add_argument(
        "--output_image_dir",
        type=Path,
        default=Path("work_dirs/sam2_prediction/visualization_image"),
        help="Output directory for per-frame visualization images. Images are written under <output_image_dir>/<video_name>/.",
    )
    parser.add_argument(
        "--output_video_dir",
        type=Path,
        default=Path("work_dirs/sam2_prediction/visualization_video"),
