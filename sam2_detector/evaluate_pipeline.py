...
try:
    ...
    from sam2_detector.pipeline.config import load_detector_config
    from sam2_detector.evaluation.pipeline import (
        EvaluationPipelineConfig,
        run_evaluation_pipeline,
    )


DEFAULT_CONFIG_CLI_PATH = "sam2_detector/configs/default.yaml"
