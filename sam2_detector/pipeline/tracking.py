...
try:
    ...
    from sam2_detector.pipeline.config import DetectionConfig
    from sam2_detector.pipeline.crop_export import build_empty_frame_annotation
    from sam2_detector.pipeline.runtime import PipelineRuntime
    from sam2_detector.utils.annotation_io import write_sequence_annotations
    from sam2_detector.utils.video_utils import create_video_from_images
...
def run_tracking_stage(
    ...
    try:
        ...
        from sam2_detector.utils.mask_dictionary_model import MaskDictionaryModel, ObjectInfo
    ...
    if enable_visualization and masked_image_output_path and masked_video_output_path:
        try:
            ...
            from sam2_detector.utils.common_utils import CommonUtils
