...
try:
    ...
    from sam2_detector.evaluation.kitti_eval import evaluate_directory
    ...
    from sam2_detector.evaluation.to_kitti_format_gt import collect_gt_sequence_names, convert_directory_to_kitti
    from sam2_detector.evaluation.to_kitti_format_pred import convert_to_kitti_format, export_prediction_details
    from sam2_detector.utils.fish_label_map import FINE_CLASSES
