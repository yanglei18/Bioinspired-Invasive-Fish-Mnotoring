...
try:
    ...
    from sam2_detector.utils.annotation_io import load_prediction_sequences
    from sam2_detector.utils.fish_label_map import FINE_CLASSES, normalize_fish_class_name
...
def convert_to_kitti_format(
    ...
    if not sequences:
        raise FileNotFoundError(
            ...
            "Expected a root perdiction.json, a single sequence perdiction.json, "
...
def main() -> None:
    ...
    parser.add_argument(
        "--input_dir",
        type=str,
        default="work_dirs/sam2_prediction/annotation_det",
        help="Prediction root containing perdiction.json or legacy per-frame JSON files",
    )
    parser.add_argument(
        "--output_dir",
        type=str,
        default="work_dirs/sam2_prediction/kitti_eval_run/pred/SAM2Detector/data",
