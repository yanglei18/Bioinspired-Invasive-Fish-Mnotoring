...
try:
    ...
    from sam2_detector.evaluation.reporting import to_jsonable
    from sam2_detector.evaluation.to_kitti_format_gt import (
        collect_gt_frame_ids_by_sequence,
        collect_gt_sequence_names,
        convert_directory_to_kitti,
    )
    from sam2_detector.evaluation.to_kitti_format_pred import convert_to_kitti_format
...
def _load_tracking_eval() -> tuple[Any | None, str | None]:
    try:
        ...
        try:
            from sam2_detector.evaluation.run_kitti import run_tracking_eval
